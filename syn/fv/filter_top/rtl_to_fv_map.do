...
# Generated on: Mon Dec 04 18:30:51 EST 2023 (Mon Dec 04 23:30:51 UTC 2023)
...
set logfile fv/filter_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/filter_top -revised fv_map
...
add_search_path /opt/cadence/libraries/gsclib045_all_v4.7/gsclib045/timing -library -both
read_library -liberty -both \
    /opt/cadence/libraries/gsclib045_all_v4.7/gsclib045/timing/fast_vdd1v2_basicCells.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/filter_top.sv ../rtl/SPI.sv ../rtl/fir_transpose.sv ../rtl/mult12x12.sv
elaborate_design -golden -root {filter_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/filter_top/fv_map.v.gz
elaborate_design -revised -root {filter_top}
...
#add_name_alias fv/filter_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.filter_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.filter_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.filter_top.rtl.fv_map.rpt
