...
# Generated on: Wed Dec 06 23:02:51 EST 2023 (Thu Dec 07 04:02:51 UTC 2023)
...
set logfile fv/fir_transpose/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fir_transpose -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../rtl/fir_transpose.sv ../rtl/mult12x12.sv
elaborate_design -golden -root {fir_transpose} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fir_transpose/fv_map.v.gz
elaborate_design -revised -root {fir_transpose}
...
#add_name_alias fv/fir_transpose/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fir_transpose.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fir_transpose.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fir_transpose.rtl.fv_map.rpt
