...
if {$_slk_ != "30.5"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 30.5,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:filter_top]]" != "{{mode:filter_top/func_default 30.5}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:filter_top/func_default 30.5}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:filter_top]]"
}
# tns
...
if {$_cell_area_ != "67338"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 67338,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "31945"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 31945,  current net area: $_net_area_"
}
unset _net_area_
